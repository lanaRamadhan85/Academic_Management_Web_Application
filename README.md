...
Aplikasi manajemen akademik berbasis web untuk mengelola data mahasiswa, mata kuliah, dan nilai secara efisien. Dibangun dengan **pure HTML, CSS, dan JavaScript** tanpa framework — menggunakan arsitektur **OOP (Class-based)**.
